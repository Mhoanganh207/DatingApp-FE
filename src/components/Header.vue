...
<form class="space-y-6" action="#" >
    <div style="margin-top: 0;">
        ...
        <input v-model="email" type="email" name="email" id="email" placeholder="name@company.com" class="logIn-input bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5 " required>

    </div>
    <div>
        <label for="password" class="block mb-2 text-md font-medium text-">Your password</label>
        <input v-model="password" type="password" name="password" id="password" placeholder="••••••••" class="logIn-input bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5 " required>
    ...
    <div class="text-md font-medium text-gray-500 ">
        Not registered? <a @click="$router.push('/account/signup')" class="text-pink-700 hover:underline dark:text-pink-500">Create account</a>
    </div>
</form>
    <div class="flex mt-2">
